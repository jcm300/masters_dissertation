...
Os passos seguintes serão a realização da primeira instalação na nova máquina, bastando para isso seguir a descrição dada na secção~\ref{sec:inst-prim} mas sem realizar o povoamento do \textit{MongoDB}.
