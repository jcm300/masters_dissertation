...
Por forma a contrariar o aumento da complexidade da \acrshort{api} de dados com a adição do controlo de acesso e da autenticação pretende-se investigar se a criação de um \textit{\acrshort{api} Gateway} simplifica a comunicação entre interface/utilizadores e a \acrshort{api} de dados.
...
\begin{itemize}
    ...
    \item Criação de uma \textit{\acrshort{api} Gateway} na \acrshort{clav}
