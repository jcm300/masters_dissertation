...
\begin{lstlisting}[caption=Recomendações de segurança na configuração \textit{Nginx}]
  server {
    ...
    #Melhora tolerância quando o endereço de um dominio muda
