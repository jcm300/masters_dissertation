...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Arquitetura do \textit{Express Gateway}. Fonte:~\cite{kongArch}}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Arquitetura do \textit{Kong}. Fonte:~\cite{kongArch}}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{Arquitetura do \textit{Tyk}. Fonte:~\cite{tyk}}
\end{figure}
