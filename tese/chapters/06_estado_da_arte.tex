...
\begin{lstlisting}[language=xml, caption=Pequeno exemplo em \acrshort{xml}]
...
Existe uma grande quantidade de conversores de \acrshort{json} para \acrshort{xml}. Por essa razão foram apenas aprofundadas as bibliotecas que em média são mais populares, com melhor qualidade e com mais manutenção segundo o \acrshort{npm}. Para tal, foram consideradas as seguintes bibliotecas:
\begin{itemize}
    \item \href{https://www.npmjs.com/package/xml-js}{\texttt{xml-js}}: 50.3\% (41p+94q+16m)
    \item \href{https://www.npmjs.com/package/jsontoxml}{\texttt{jsontoxml}}: 39.3\% (24p+91q+3m)
    \item \href{https://www.npmjs.com/package/xmlbuilder}{\texttt{xmlbuilder}}: 52.7\% (63p+62q+33m)
    \item \href{https://www.npmjs.com/package/easyxml}{\texttt{easyxml}}: 32.7\% (15p+83q+0m)
    \item \href{https://www.npmjs.com/package/js2xmlparser}{\texttt{js2xmlparser}}: 46\% (42p+63q+33m)
    \item \href{https://www.npmjs.com/package/fast-xml-parser}{\texttt{fast-xml-parser}}: 43\% (33p+63q+33m)
    \item \href{https://www.npmjs.com/package/xml2js}{\texttt{xml2js}}: 50.3\% (77p+41q+33m)
    \item \href{https://www.npmjs.com/package/jxon}{\texttt{jxon}}: 35.7 (16p+91q+0m)
    \item \href{https://www.npmjs.com/package/jstoxml}{\texttt{jstoxml}}: 48.7\% (19p+94q+33m)
    \item \href{https://www.npmjs.com/package/export-from-json}{\texttt{export-from-json}}: 31\% (7p+64q+22m)
\end{itemize}

Assim, serão de seguida aprofundadas as bibliotecas \texttt{xml-js}, \texttt{xmlbuilder} e \texttt{xml2js}.
...
\subsubsection{O que é \acrshort{csv}}
%TODO
TODO

\subsubsection{Bibliotecas}

Da mesma forma como no caso anterior antes de cada biblioteca ser aprofundada serão escolhidas aquelas que em média são mais populares, com melhor qualidade e com mais manutenção segundo o \acrshort{npm}. Para tal, foram consideradas as seguintes bibliotecas:
\begin{itemize}
    \item \href{https://www.npmjs.com/package/papaparse}{\texttt{papaparse}}: 56.7\% (43p+94q+33m)
    \item \href{https://www.npmjs.com/package/json2csv}{\texttt{json2csv}}: 46.3\% (42p+64q+33m)
    \item \href{https://www.npmjs.com/package/json-csv}{\texttt{json-csv}}: 46.7\% (16p+91q+33m)
    \item \href{https://www.npmjs.com/package/jsonexport}{\texttt{jsonexport}}: 32.7\% (25p+95q+10m)
\end{itemize}
%TODO
TODO
...
\subsubsection{Formatos a Exportar}
%TODO: explicar os formatos passíveis de exportar
TODO
