...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\textwidth]{img/swaggerUI.png}
    \end{center}
    \caption{\textit{Swagger \acrshort{ui}} exemplo}
\end{figure}

\subsubsection{Alternativas}
Existem algumas alternativas ao \textit{Swagger \acrshort{ui}} que interpretam também a especificação \textit{OpenAPI}:
\begin{itemize}
    \item \textit{ReDoc}\footnote{Ver \url{https://github.com/Redocly/redoc}}
    \item \textit{OpenAPI-GUI}\footnote{Ver \url{https://github.com/Mermade/openapi-gui}}
    \item \textit{angular-swagger-ui}\footnote{Ver \url{https://github.com/Orange-OpenSource/angular-swagger-ui}}
    \item \textit{Swagger UI responsive theme}\footnote{Ver \url{https://github.com/jensoleg/swagger-ui}}
\end{itemize}

Das quatro alternativas a que se encontra mais polida é a \textit{ReDoc}. Contudo ainda não se encontra ao nível do \textit{Swagger \acrshort{ui}} em termos de interactividade e aspeto visual. Apesar disso é uma interface de documentação a considerar no futuro.
