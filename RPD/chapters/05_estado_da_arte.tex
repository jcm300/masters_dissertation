    ...
    for key in convert_to[type]
        ...
        if k in json then
            ...
            if header == null then
                ...
                csvLines[1].push(protect(value))
        else if type == "pca" or type == "df" then
            csvLines[0].push(protect(header))
...
No caso da conversão de uma lista de objetos, para cada objeto será feita a conversão como se fosse apenas um objeto, sendo depois ignorado a linha dos títulos em todos os objetos exceto no caso do primeiro objeto em que são mantidos os títulos gerados.
%TODO
%Algoritmo
