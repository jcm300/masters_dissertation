...
O \acrfull{saml} define uma \textit{framework} \textit{standard} em \acrshort{xml} para a troca segura de informação entre entidades \textit{web}.

Existem dois tipos de \textit{provides} em \acrshort{saml}:
%TODO
